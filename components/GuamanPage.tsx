      ...
      <div className="animate-fadeIn space-y-6">
        <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/10 pb-6">
          <div className="flex items-center gap-4">
            <button 
              ...
              className="w-12 h-12 flex items-center justify-center bg-slate-100 dark:bg-[#111111] text-black dark:text-white rounded-full hover:bg-white dark:bg-[#000000] hover:text-black dark:hover:text-white transition-all border border-slate-200 dark:border-white/10 shadow-lg group"
            >
              <i className="fas fa-chevron-left group-hover:-translate-x-1 transition-transform"></i>
            </button>
            <div>
              <h2 className="text-2xl md:text-3xl font-black uppercase tracking-tighter text-slate-900 dark:text-white drop-shadow-md">{client.name}</h2>
              <p className="text-black dark:text-white text-[10px] font-black uppercase tracking-[0.3em]">{client.detail}</p>
            </div>
          </div>
          <div className="flex gap-2">
            <button 
              onClick={() => onPrintStatement(selectedClientIdx, ledgerNotes, ledgerStartDate, ledgerEndDate)}
              className="px-6 py-3 bg-black dark:bg-white text-white dark:text-black rounded-full font-black text-[10px] uppercase tracking-widest hover:bg-slate-100 dark:hover:bg-[#1a1a1a] transition-all shadow-lg shadow-slate-300 flex items-center gap-2 group hover:text-black dark:hover:text-white"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-slate-50 dark:bg-[#0a0a0a] p-8 rounded-3xl border border-slate-200 dark:border-white/10 shadow-2xl">
              <h3 className="text-black dark:text-white text-[10px] font-black uppercase tracking-[0.3em] mb-6 border-b border-slate-200 dark:border-white/10 pb-4 italic">Rekod Transaksi Baru</h3>
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-white dark:bg-[#000000] border border-slate-200 dark:border-white/10 rounded-2xl p-4 text-xs font-bold text-slate-900 dark:text-white outline-none focus:border-slate-300 dark:border-white/20 h-24 resize-none"
                  />
                </div>
                <div className="space-y-1.5">
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            <div className="bg-slate-50 dark:bg-[#0a0a0a] rounded-3xl border border-slate-200 dark:border-white/10 overflow-x-auto shadow-2xl flex-grow">
                      ...
                      <tr key={i} className="group hover:bg-slate-100 dark:hover:bg-[#1a1a1a] transition-colors">
                        ...
                        <td className="p-6 text-center">
                          <button 
                            ...
                            className="w-8 h-8 flex items-center justify-center text-gray-800 hover:text-black dark:hover:text-white transition-colors"
                          >
            ...
            <div className="bg-slate-50 dark:bg-[#0a0a0a] p-8 rounded-3xl border border-slate-200 dark:border-white/10 shadow-2xl flex justify-between items-center">
              <div>
                <p className="text-[9px] font-black uppercase tracking-[0.3em] text-gray-600 mb-1 italic">Kedudukan Kewangan Fail</p>
                <div className={`text-5xl font-black tracking-tighter tabular-nums ${balance > 0 ? 'text-black dark:text-white' : 'text-emerald-500'}`}>
                  RM {balance.toLocaleString('en-MY', { minimumFractionDigits: 2 })}
                </div>
              </div>
              <div className="opacity-10">
                <i className="fas fa-gavel text-6xl text-black dark:text-white"></i>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="animate-fadeIn space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-end gap-4 border-b border-slate-200 dark:border-white/10 pb-6">
        <div>
          <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tighter text-slate-900 dark:text-white drop-shadow-lg">Pengurusan Fail Guaman</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4">
          <form onSubmit={handleSubmit} className="bg-slate-50 dark:bg-[#0a0a0a] p-8 rounded-3xl border border-slate-200 dark:border-white/10 shadow-2xl sticky top-8">
            <h3 className="text-black dark:text-white text-xs font-black uppercase tracking-[0.3em] mb-8 border-b border-slate-200 dark:border-white/10 pb-4 italic">Daftar Fail Baru</h3>
            ...
            <BlobButton type="submit" className="w-full mt-8 py-4 text-black dark:text-white font-black uppercase tracking-widest text-xs">
              Simpan Rekod Fail
            </BlobButton>
          </form>
        </div>
        ...
        <div className="lg:col-span-8">
          {selectedIds.length > 0 && (
            <div className="bg-black/10 border border-slate-300 dark:border-white/20 rounded-2xl p-4 mb-4 flex flex-col sm:flex-row items-center justify-between gap-4 animate-fadeIn">
              <span className="text-black dark:text-white text-xs font-black uppercase tracking-widest">{selectedIds.length} Rekod Dipilih</span>
              <div className="flex gap-3">
                <button 
          ...
          <div className="bg-slate-50 dark:bg-[#0a0a0a] rounded-3xl border border-slate-200 dark:border-white/10 overflow-x-auto shadow-2xl">
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-white/10">
                {clients.length === 0 ? (
                  ...
                  clients.map((client, idx) => {
                    ...
                    return (
                      <tr key={client.id} className="group hover:bg-slate-100 dark:hover:bg-[#1a1a1a] transition-colors">
                        <td className="p-6 text-center">
                          <input 
                            type="checkbox" 
                            className="accent-black w-4 h-4 cursor-pointer"
                        ...
                        <td className="p-6 text-right">
                          <div className="flex flex-col items-end">
                            <span className={`text-2xl font-black tabular-nums tracking-tighter ${balance > 0 ? 'text-black dark:text-white' : 'text-emerald-500'}`}>
                              RM {balance.toLocaleString('en-MY', { minimumFractionDigits: 2 })}
                            </span>
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="space-y-1.5">
        ...
        <input 
          ...
          className="w-full bg-white dark:bg-[#000000] border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white rounded-2xl p-4 text-xs font-bold focus:border-slate-300 dark:border-white/20 transition-all outline-none" 
        />
      </div>
      <div className="space-y-1.5">
        ...
        <input 
          ...
          className="w-full bg-white dark:bg-[#000000] border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white rounded-2xl p-4 text-xs font-bold focus:border-slate-300 dark:border-white/20 transition-all outline-none uppercase" 
        />
      </div>
      <div className="space-y-1.5">
      ...
      <button 
        type="submit" 
        className="w-full bg-black dark:bg-white text-white dark:text-black py-4 rounded-2xl font-black text-xs hover:bg-slate-900 transition-all shadow-lg active:scale-95 uppercase tracking-widest"
      >
        Simpan Transaksi
      </button>
    </form>
