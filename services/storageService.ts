...
export const loadFromStorage = (): AppState => {
  ...
  if (data) {
    try {
      ...
      return {
        ...
        companyContact: parsed.companyContact !== undefined ? parsed.companyContact : '011 5653 1310 / tetuanhairi@gmail.com',
  ...
  return {
    ...
    companyContact: '011 5653 1310 / tetuanhairi@gmail.com',
