...
export const loadFromStorage = (): AppState => {
  ...
  if (data) {
    try {
      ...
      return {
        ...
        generatedDocs: parsed.generatedDocs || [],
        invCounter: parsed.invCounter || 1,
        firmLogo: parsed.firmLogo || null,
        customHeader: parsed.customHeader !== undefined ? parsed.customHeader : 'HAIRI MUSTAFA ASSOCIATES',
        customFooter: parsed.customFooter || '',
        companyAddress: parsed.companyAddress !== undefined ? parsed.companyAddress : 'Lot 02, Bangunan Arked Mara, 09100 Baling, Kedah',
        companyContact: parsed.companyContact !== undefined ? parsed.companyContact : 'Tel: 01156531310 | Emel: tetuanhairi@gmail.com',
        defaultPrintMode: parsed.defaultPrintMode || 'standard',
  ...
  return {
    ...
    invCounter: 1,
    firmLogo: null,
    customHeader: 'HAIRI MUSTAFA ASSOCIATES',
    customFooter: '',
    companyAddress: 'Lot 02, Bangunan Arked Mara, 09100 Baling, Kedah',
    companyContact: 'Tel: 01156531310 | Emel: tetuanhairi@gmail.com',
